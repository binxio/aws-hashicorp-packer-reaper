...
import click
import boto3
from aws_hashicorp_packer_reaper.reaper import destroy_expired_instances, list_packer_instances
...
def stop(ctx,hours):
    ...
    destroy_expired_instances(boto3.client("ec2"), dry_run=ctx.obj['dry_run'], hours=hours, mode="stop")
...
def terminate(ctx,hours):
    ...
    destroy_expired_instances(boto3.client("ec2"), dry_run=ctx.obj['dry_run'], hours=hours, mode="terminate")
